...
def multiple_references_explanation(x, a, b, c):
    return a * x * x + b * x + c
...
def quadratic(x, a, b, c):
    ...
    """
    r3 = -1.0 * b / (2 * a)
    r1 = multiple_references_explanation(upper_bound(x), a, b, c)
    r2 = multiple_references_explanation(lower_bound(x), a, b, c)
    if (r3 < upper_bound(x) and r3 > lower_bound(x)):
        r3 = multiple_references_explanation(r3, a, b, c)
        return interval(min(r3, r1, r2), max(r1, r2, r3))
